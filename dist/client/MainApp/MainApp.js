...
function MainPage(props) {
    ...
    return React.createElement(Page, elProps(props.path).props,
        ...
        React.createElement(TextElement, elProps(pathTo('Title')).styles(elProps(pathTo('Title.Styles')).fontWeight('bold').fontFamily('"Jersey 10"').fontSize('48').color('blue').props).content('Sum Mix-up').props),
...
Or Start Game to dive straight in!`).props),
        ...
        React.createElement(Block, elProps(pathTo('PlayPanel')).layout('vertical').show(Or(Status == 'Playing', Status == 'Ended')).styles(elProps(pathTo('PlayPanel.Styles')).width('100%').padding('0').props).props,
            React.createElement(Block, elProps(pathTo('NumbersBlock')).layout('horizontal').styles(elProps(pathTo('NumbersBlock.Styles')).minHeight('57').border('1px solid lightgray').padding('5').minWidth('280').props).props,
            React.createElement(ItemSet, elProps(pathTo('NumbersItemSet')).itemContentComponent(MainPage_NumbersItemSetItem).props),
    ),
            React.createElement(Block, elProps(pathTo('OperationsBlock')).layout('horizontal').styles(elProps(pathTo('OperationsBlock.Styles')).minHeight('57').border('1px solid lightgray').padding('5px').minWidth('210').props).props,
            React.createElement(ItemSet, elProps(pathTo('OperationsItemSet')).itemContentComponent(MainPage_OperationsItemSetItem).props),
    ),
            React.createElement(Block, elProps(pathTo('Row1')).layout('horizontal').styles(elProps(pathTo('Row1.Styles')).paddingLeft('84').props).props,
            React.createElement(Block, elProps(pathTo('Num1Position')).layout('vertical').dropAction(Num1Position_dropAction).styles(elProps(pathTo('Num1Position.Styles')).minHeight('70').props).props,
            React.createElement(ItemSet, elProps(pathTo('Num1ItemSet')).itemContentComponent(MainPage_Num1ItemSetItem).props),
    ),
    ),
            React.createElement(Block, elProps(pathTo('Row2')).layout('horizontal').styles(elProps(pathTo('Row2.Styles')).props).props,
            React.createElement(Block, elProps(pathTo('Op1Position')).layout('vertical').dropAction(Op1Position_dropAction).styles(elProps(pathTo('Op1Position.Styles')).height('50').minHeight('65').props).props,
            React.createElement(ItemSet, elProps(pathTo('Op1ItemSet')).itemContentComponent(MainPage_Op1ItemSetItem).props),
    ),
            React.createElement(Block, elProps(pathTo('Num2Position')).layout('vertical').dropAction(Num2Position_dropAction).styles(elProps(pathTo('Num2Position.Styles')).minHeight('70').props).props,
            React.createElement(ItemSet, elProps(pathTo('Num2ItemSet')).itemContentComponent(MainPage_Num2ItemSetItem).props),
    ),
            React.createElement(TextElement, elProps(pathTo('Equals1')).styles(elProps(pathTo('Equals1.Styles')).fontSize('32').paddingTop('10').props).content('=').props),
            React.createElement(TextElement, elProps(pathTo('Result1Display')).styles(elProps(pathTo('Result1Display.Styles')).fontSize('32').paddingTop('10').props).content(Result1).props),
    ),
            React.createElement(Block, elProps(pathTo('Row3')).layout('horizontal').props,
            React.createElement(Block, elProps(pathTo('Op2Position')).layout('vertical').dropAction(Op2Position_dropAction).styles(elProps(pathTo('Op2Position.Styles')).height('50').minHeight('65').props).props,
            React.createElement(ItemSet, elProps(pathTo('Op2ItemSet')).itemContentComponent(MainPage_Op2ItemSetItem).props),
    ),
            React.createElement(Block, elProps(pathTo('Num3Position')).layout('vertical').dropAction(Num3Position_dropAction).styles(elProps(pathTo('Num3Position.Styles')).minHeight('70').props).props,
            React.createElement(ItemSet, elProps(pathTo('Num3ItemSet')).itemContentComponent(MainPage_Num3ItemSetItem).props),
    ),
            React.createElement(TextElement, elProps(pathTo('Equals2')).styles(elProps(pathTo('Equals2.Styles')).fontSize('32').paddingTop('10').props).content('=').props),
            React.createElement(TextElement, elProps(pathTo('Result2Display')).styles(elProps(pathTo('Result2Display.Styles')).fontSize('32').paddingTop('10').props).content(Result2).props),
    ),
            React.createElement(Block, elProps(pathTo('Row4')).layout('horizontal').props,
            React.createElement(Block, elProps(pathTo('Op3Position')).layout('vertical').dropAction(Op3Position_dropAction).styles(elProps(pathTo('Op3Position.Styles')).height('50').minHeight('65').props).props,
            React.createElement(ItemSet, elProps(pathTo('Op3ItemSet')).itemContentComponent(MainPage_Op3ItemSetItem).props),
    ),
            React.createElement(Block, elProps(pathTo('Num4Position')).layout('vertical').dropAction(Num4Position_dropAction).styles(elProps(pathTo('Num4Position.Styles')).height('50').minHeight('65').props).props,
            React.createElement(ItemSet, elProps(pathTo('Num4ItemSet')).itemContentComponent(MainPage_Num4ItemSetItem).props),
    ),
            React.createElement(TextElement, elProps(pathTo('Equals3')).styles(elProps(pathTo('Equals3.Styles')).fontSize('32').paddingTop('10').props).content('=').props),
            React.createElement(TextElement, elProps(pathTo('Result3Display')).styles(elProps(pathTo('Result3Display.Styles')).fontSize('32').paddingTop('10').props).content(Result3).props),
    ),
